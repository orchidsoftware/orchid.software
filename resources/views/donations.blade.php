        ...
        <div class="row my-3 my-md-5">
            <div class="col-12 col-lg-6 mx-auto text-md-center">
                ...
                <h1 class="display-5 fw-bold px-3">
                    <span class="d-block d-md-inline-block">Your Donation <span class="text-primary d-block">Makes a Difference!</span></span>
                </h1>

                <p class="lead text-muted mb-md-5 mb-3 opacity-slow intersection px-3">
                    Your contribution empowers us to continue developing and maintaining this open-source packages and provide ongoing support to the community.
                </p>
            </div>
        </div>
