...
@section('body')
    ...
    <div class="container col-xxl-8 px-md-4 py-md-5">
    ...
    z-index: 3;
    bottom: 35%;">
            <div class="card-body d-flex flex-column px-4 py-5 px-lg-5 pb-0">
                <div class="row align-items-end g-5">

                    <div class="col-12 col-lg-6 my-lg-auto py-lg-5">
                        <div class="p-md-4">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="bg-body-tertiary me-md-3 pt-3 px-md-3 pt-md-5 px-md-5 text-center overflow-hidden px-0">

                            <div class="bg-dark shadow-sm mx-auto" style="min-height: 300px; border-radius: 21px 21px 0 0;">
                                <div class="list-group text-start p-4 p-xl-5">

                                    <div>
                                        <img src="/img/next/feature3.svg" class="img-fluid mx-auto d-none d-lg-block">
                                    </div>
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                                        <img src="https://github.com/agoalofalife.png" alt="agoalofalife" width="48" height="48" class="rounded-circle flex-shrink-0">
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                            <div>
                                                <h6 class="mb-0">Ilya Chubarov</h6>
                                                <p class="mb-0 opacity-75">Troubleshooting Common Issues.</p>
                                            </div>
                                            <small class="opacity-50 text-nowrap">10h</small>
                                        </div>
                                    </div>
                                    --}}
                                    <div class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                                        <img src="https://github.com/Arkokeando.png" alt="Arkokeando" width="48" height="48" class="rounded-circle flex-shrink-0">
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                            <div>
                                                <h6 class="mb-0">Arkokeando</h6>
                                                <p class="mb-0 opacity-75">Paginate table records.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                                        <img src="https://github.com/m-pastuszek.png" alt="m-pastuszek" width="48" height="48" class="rounded-circle flex-shrink-0">
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                            <div>
                                                <h6 class="mb-0">m-pastuszek</h6>
                                                <p class="mb-0 opacity-75">Relation <code class="rounded">fromModel</code> custom name</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                                        <img src="https://github.com/Muratcol.png" alt="Muratcol" width="48" height="48" class="rounded-circle flex-shrink-0">
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                            <div>
                                                <h6 class="mb-0">Muratcol</h6>
                                                <p class="mb-0 opacity-75">How can I make a newly created controller available for public access?</p>
                                            </div>
                                        </div>
                                    </div>


                                    <div class="d-flex flex-column flex-md-row justify-content-md-start pt-4 gap-3">
