    ...
    <div class="container">
        ...
        <div class="row align-items-center my-3 py-3 my-md-5 py-md-5">
            ...
            <div class="col-12 col-md-5">
                ...
                <h2 class="display-5 fw-bold px-3">Free and <span class="text-primary">Open Source</span>
                ...
                <a href="/en/license" class="link-secondary d-block stretched-link text-decoration-none link-more px-3">View License
                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" viewBox="0 0 16 16">
