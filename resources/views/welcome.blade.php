    ...
    <div class="container position-relative d-none d-md-block" style="margin-top: -13em; z-index: 3">
        <div class="col-lg-10 mx-auto">
            <img src="/img/next/screen.png"
                 class="pe-none img-fluid rounded shadow">
        </div>
    </div>
    ...
    <div class="container">
        <div class="row my-3 my-md-5">
            <div class="col-lg-6 mx-auto text-center">
                <h1 class="display-5 fw-bold">Develop <span class="text-primary">web applications</span>
            ...
            <div class="row flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-grid gap-1 d-md-flex justify-content-md-start">
                        ...
                        <a href="https://opencollective.com/orchid" class="btn btn-link btn-lg">Become a baker</a>
                    </div>
                </div>
            </div>
        </div>
