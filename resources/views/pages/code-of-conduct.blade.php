            ...
            <div class="row  m-t-md m-b-xl">
                <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                        ...
                        <hr>
                        <p>
                            <em>Кодекс поведения ORCHID распространяется под лицензией
                                <a href="http://creativecommons.org/licenses/by-sa/3.0/"
                                   target="_blank"
                                   rel="noopener">Creative Commons Attribution-Share Alike 3.0</a>. Некоторые пункты были вдохновлены
                                <a
                                        href="http://www.ubuntu.com/about/about-ubuntu/conduct"
                                        target="_blank"
                                        rel="noopener">Ubuntu Code of Conduct</a>.
                            </em>
                        </p>
                    </div>
                </div>
