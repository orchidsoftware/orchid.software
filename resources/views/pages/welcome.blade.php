            ...
            <div class="m-t-xxl m-b-xl">
                <div class="row v-center">
                    ...
                    <div class="col-md-7 no-padder hidden-xs">
                        <img src="/img/partners.svg" style="
    max-width: 500px;
    object-fit: cover;
    height: 300px;
    margin: 0 auto;
            ...
            <div class="row m-b-xxl b-b r-2x b-2x b-dark" style="box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);">
                ...
                <div class="col-md-6 col-xs-12 sm-text-center">
                    ...
                    <div class="text-center">
                        <a href="https://www.paypal.me/tabuna/10usd" target="_blank" id="form-donate"
                           class="btn btn-rounded btn-dark m-b">
                ...
                <div class="row m-b-xxl v-center">
                    ...
                    <div class="col-sm-6">
                        <a href="https://www.jetbrains.com/phpstorm" target="_blank"><img
                                    src="/img/sponsors/JetBrains.png" class="img-responsive"></a>
                    </div>
                    <div class="col-sm-6">
                        <a href="http://laravel.su" target="_blank"><img src="/img/sponsors/laravelrus.png"
                                                                         style="height: 80px"
                                                                         class="img-responsive"></a>
                    </div>
                    ...
                    <div class="col-sm-12 m-b-xl">
                        <h4 class="font-thin l-h-2x  m-b-lg">
                            <a href="https://twitter.com/themsaid/status/892387647733342208" target="_blank">
                                <em>“If you are looking for CMS package for your laravel project this package looks nice
                                    to me :)”</em>
                            </a>
                        </h4>
                        <p class="text-muted text-right">- <a
                                    href="https://twitter.com/themsaid/status/892387647733342208">Mohamed Said, First
                                                                                                  officer of Laravel</a>
                        </p>
                    </div>
                </div>
            </div>
