            ...
            <div class="row v-center m-t-lg m-b-md padder-v">
              ...
              <div class="row">
                  <div class="col-md-9 b-r">
                      ...
                      @foreach($posts->slice(0,5) as $key => $new)
                          ...
                          <div class="row">
                                  ...
                                  <div class="item">
                                      <div class="pos-rlt">
                                          ...
                                          <div class="item-overlay bg-black-opacity r r-2x">
                                              <div class="center text-center m-t-n w-full">
                                                  <a href="{{route('blog.show',$new->slug)}}"><i class="icon-control-play text-2x text-white"></i></a>
                                              </div>
                                          </div>
                                          <a href="{{route('blog.show',$new->slug)}}"><img src="{{$new->getContent('picture')}}" alt="" class="img-full img-responsive r r-2x"></a>
                                      </div>
                              ...
                              <div class="col-md-7">
                                  ...
                                  <div class="">
                                      ...
                                      <h3 class="h3"><a href="{{route('blog.show',$new->slug)}}">{{$new->getContent('name')}}</a></h3>
                                      <div class="small">
                  ...
                  <div class="col-md-3">
                      @foreach($posts->slice(5,10) as $key => $new)
