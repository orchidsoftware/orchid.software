...
@section('content')
    ...
    <div class="bg-white">
        <div class="container">
            <div class="row m-t-xl m-b-xl b-b">
                <div class="col-sm-8 wrapper-xl">
                    <h1 class="font-thin m-t-n l-h-1x padder-v text-black">О компании</h1>
                ...
                <div class="col-sm-4 fadeInLeft animated" data-ride="animated" data-animation="fadeInLeft" data-delay="300">
    ...
    <div class="container">
        <div class="row v-center m-t-xxl m-b-xxl">
            ...
            <div class="container">
                ...
                <div class="row wrapper-lg">
                    <div class="col-md-10 col-md-offset-1">
                        <p class="h1 font-thin">We <span class="text-primary">Provides</span></p>
    ...
    <div class="m-t-xxl">
        ...
        <div class="row bg-black b-b box-shadow v-center">
                ...
                <div class="row v-center">
                    ...
                    <div class="col-md-5 col-md-offset-3">
                        <div class="wrapper-lg">
                            ...
                            <p class="text-right m-t-md font-thin text-white">- Barak <span class="text-primary">Obama</span></p>
                        </div>
