...
@section('body')
    ...
    bottom: 20%">
                ...
                <div class="col-12 col-md me-auto bg-white py-md-3">
                    <main class="py-2 px-3 py-md-4 px-md-4 ms-md-4 me-md-auto order-md-first">
                        <div class="d-flex align-items-center mb-3 mt-3">
                            <h1 class="me-3">{{ $title }}</h1>

                            <a href="{{ $edit }}" class="text-muted ms-auto d-none d-md-flex align-items-center text-decoration-none">
