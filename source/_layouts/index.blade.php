...
@section('content')
        ...
        <div class="container pt-md-2">
            <div class="row my-4">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex flex-column flex-md-row">
                        <a href="/@yield('lang')/docs" class="btn btn-lg btn-outline-primary btn-rounded mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="1em" height="1em"
                        ...
                        <a href="https://demo.orchid.software/" class="btn btn-lg btn-bd-primary mb-3 mr-md-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" preserveAspectRatio="xMidYMid"
                                 width="1em" height="1em" fill="currentColor" viewBox="0 0 32 26">
                ...
                <div class="d-none d-md-block col position-relative">
                    <img src="https://raw.githubusercontent.com/orchidsoftware/platform/master/.github/IMAGES/promo-full.png"
    ...
    <section class="bg-white">
        <div class="container pt-5 pb-5">
            ...
            <div class="row padder-v mt-md-3 row-cols-1 row-cols-md-3">
                <div class="col mb-5 py-2">
                    <div class="item">
                ...
                <div class="col mb-5 py-2">
                    ...
                    <div class="item">
                        ...
                        <div class="linear-gradient h-1/2 bg-primary w-xs mt-3 mb-3" style="height: 2px;"></div>
                        <div class="item-desc">
                            When the file is loaded, a hash is generated and no duplicates are physically stored on
                            disk. It can also be easily linked to an Eloquent record.
                        </div>
                    </div>
                ...
                <div class="col mb-5 py-2">
                    <div class="item">
                        ...
                        <div class="linear-gradient h-1/2 bg-primary w-xs mt-3 mb-3" style="height: 2px;"></div>
                        <div class="item-desc">
                            Users from different countries? You can translate into any language of your choice. All
                            texts in the entire application can be translated.
                        </div>
                    </div>
                </div>
                <div class="col mb-5 py-2">
                ...
                <div class="col mb-5 py-2">
                    ...
                    <div class="item">
                        ...
                        <div class="linear-gradient h-1/2 bg-primary w-xs mt-3 mb-3" style="height: 2px;"></div>
                        <div class="item-desc">
                            There is no need to tie employees to the workplace. All of these cool things can be used
                            from a mobile device, tablet, or desktop computer.
                        </div>
                    </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-4">
                                <img alt="image" class="img-fluid rounded"
                                     src="/assets/img/testimonials/Pavlov-Pavel.jpg">
                            </div>
                ...
                <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
                    <div class="shadow-sm p-4 border-top b-primary">
                        <div class="row no-gutters align-items-center">
                            <div class="col-4">
                                <img alt="image" class="img-fluid rounded"
                                     src="/assets/img/testimonials/Lemys-Lopez.jpg">
                            </div>
                            <div class="col-auto mr-auto">
                ...
                <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
                    <div class="shadow-sm p-4 border-top b-primary">
                        <div class="row no-gutters align-items-center">
                            <div class="col-4">
                                <img alt="image" class="img-fluid rounded"
                                     src="/assets/img/testimonials/Vladislav-Ponomarev.jpg">
                            </div>
                            <div class="col-auto mr-auto">
