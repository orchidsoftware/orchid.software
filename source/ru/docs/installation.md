...
Прежде чем вы сможете использовать ORCHID, вам нужно будет установить его. У нас есть полное руководство по установке, которое охватывает все возможности. Это руководство поможет вам выполнить простую установку, чтобы запустить проект.
...
В зависимости от того, насколько вы новичок, вы можете попробовать пошаговый пример работы с пакетом на странице ["Быстрый старт"](/ru/docs/quickstart) или просто погрузиться в [документацию](/ru/docs/screens).
