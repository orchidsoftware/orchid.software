...
Двухфакторная проверка подлинности обеспечивает вашим пользователям дополнительную безопасность учетной записи, требуя, чтобы они указывали токен во время входа в систему в дополнение к своим имени пользователя и паролю. 

По умолчанию используется алгоритм TOTP в качестве поставщика двухфакторной аутентификации. Тем не менее, вы можете реализовать свой собственный поставщик двухфакторной аутентификации, если хотите.
...
Вызов этого метода добавит проверку токена для учётных записей при авторизации.
