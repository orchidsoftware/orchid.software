...
Иногда может потребоваться получить значение из `query` экрана, а не полагаться только на `target`. Вы мМодальное окно можно отображать, не только ожете получить значение следующим образом:
