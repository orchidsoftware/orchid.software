...
Это краткое руководство представляет собой базовое введение в инфраструктуру Orchid и включает в себя информацию
...
> Обратите внимание, в laravel по умолчанию включен `smtp` драйвер для отправки почты, 
