...
Поставляется в виде пакета для Laravel и взаимодействует с другими компонентами. Может выступать в качестве основы для backoffice-приложений, панели администрирования или выполнять функции системы управления контентом. 
