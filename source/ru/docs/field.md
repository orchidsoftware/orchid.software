...
Группа используется для объединения несколько полей на одной строке.
...
Для того, что бы определить ширину полей, необходимо использовать один из предложенных методов.
