...
Одним из элементов презентации являются "Layouts" (макеты) которые могут отображаться в различных вариациях, если попытаться обьяснить коротко, то получиться, что это `view` на стеройдах.
