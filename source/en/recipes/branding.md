...
Для изменения в шапке сатраницы или футере в них необходимо указать собственные `blade` шаблоны.
...
Допустим, что мы делаем систему для вымышленного аналитического агенства "Analytics Nest", внесем изменения в только что созданный файл:
...
так же как если бы передавали аргумент в помощник `view('brand.header')`:
...
> **Обратите внимание** Файл конфигурации может быть закэширован и изменения не вступят всилу, до выполнения комманды `php artisan config:clear`
