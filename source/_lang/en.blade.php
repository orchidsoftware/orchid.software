...
@section('main.title')
    Platform for <span class="b-b b-2x b-primary">back-office applications</span><br> on Laravel Framework
@endsection
...
@section('main.documentation','Documentation')
@section('main.icons','Icons')
@section('main.discussion','Discussion')
@section('main.support','Support')
