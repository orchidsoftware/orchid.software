...
@section('main.col6.description','Используйте для включения или отключения целых экранов или поведения пользовательского интерфейса в зависимости от пользователя и соответствующей принадлежности к ролям.')
