...
@section('main.title')
    Платформа для <span class="b-b b-2x b-primary">back-office приложений</span><br> на Laravel Framework
@endsection
...
@section('main.screen.title','С начало экран')
...
@section('main.design.title','Выдержаный стиль')
...
@section('main.col3.description','Разработчики и конечные пользователи совместно разрабатывают приложение, внося изменения на
...
@section('main.col4.description','Компоненты и шаблоны кода, предоставляемые вместе с платформой, являются полностью расширяемыми, обеспечивая необходимую функциональность по мере необходимости.')

@section('main.col5.title','Проверка гипотез')
@section('main.col5.description','Благодаря принципам, что пишу, то и вижу, проверки гипотез потребуется
...
@section('main.col6.description','Разграничение прав доступа пользователя или целых групп в сочетании
                            с политиками дают возможность удобного управления в разработке и поддержки.')
