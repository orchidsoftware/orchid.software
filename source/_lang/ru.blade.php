...
@section('main.col6.title','Разрешения безопасности')
@section('main.col6.description','Использоваться для включения или отключения целых экранов или поведения пользовательского интерфейса в зависимости от пользователя и соответствующей принадлежности к ролям.')
