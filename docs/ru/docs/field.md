...
> Не стесняйтесь добавлять свои поля, например, для использования удобного редактора для вас или любых компонентов. Документация по созданию ногового поля
находится в разделе [Строитель форм.](https://orchid.software/ru/docs/builder/#sozdanie-novogo-polia). 
