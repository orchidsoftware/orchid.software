...
Разделение ответственности между управлением данными и рендерингом интерфейса позволяет экранам Orchid упрощать разработку и поддержку сложных и масштабируемых веб-приложений.
