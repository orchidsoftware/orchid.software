...
Важно понимать, что каждый экран в Orchid представляет собой HTML-форму (`<form></form>`), что позволяет отправлять данные и взаимодействовать с системой удобным и предсказуемым образом.
