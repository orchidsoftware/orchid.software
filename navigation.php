...
return [
    ...
    'en' => [
        ...
        'Content control' => [
            'children' => [
                'Entities'     => '/en/docs/entities',
                'Posts'        => '/en/docs/post',
                'Tags'         => '/en/docs/tags',
                'Commentaries' => '/en/docs/comments',
                'Menu'         => '/en/docs/menu',
                //'Вложения'     => '/en/docs/attachments',
            ],
        ],
    ],
    'ru' => [
        ...
        'Платформа'             => [
            'children' => [
                ...
                'Активные ссылки'  => '/ru/docs/active',
        ...
        'Управление содержимым' => [
            'children' => [
                'Сущности'    => '/ru/docs/entities',
                'Записи'      => '/ru/docs/post',
                'Теги'        => '/ru/docs/tags',
                'Комментарии' => '/ru/docs/comments',
                'Меню'        => '/ru/docs/menu',
