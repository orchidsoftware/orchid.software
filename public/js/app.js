...
document.addEventListener("DOMContentLoaded", function () {
  var intersectionObserver = new IntersectionObserver(function (entries) {
    return processIntersectionEntries(entries);
  });

  _toConsumableArray(document.querySelectorAll('.intersection')).forEach(function (element) {
...
document.querySelectorAll('.documentation main img').forEach(function (el) {
  el.addEventListener('click', function () {
    ...
    div.style.cssText = "background: RGBA(0,0,0,.5) url('".concat(src, "') no-repeat center;\n        background-size: contain;\n        width:100%; height:100%;\n        position:fixed;\n        z-index:10000;\n        top:0; left:0;\n        cursor: zoom-out;\n        background-size: auto;");
